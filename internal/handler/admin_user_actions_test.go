...
func TestAdminUserActionErrorMappingIsExhaustiveAndRedacted(t *testing.T) {
	tests := []struct {
		...
		{service.ErrRolePermissionActionRejected, 409, "action_rejected"},
		{service.ErrRolePermissionTargetVersionConflict, 409, "target_version_conflict"},
		{service.ErrRolePermissionPolicyVersionConflict, 409, "policy_version_conflict"},
		{service.ErrRolePermissionTargetStateConflict, 409, "target_state_conflict"},
		{service.ErrRolePermissionConsumerValidation, 409, "consumer_validation_failed"},
