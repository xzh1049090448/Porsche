...
func TestAdminOperationResponseMigrationIsLatestAndChecksumProtected(t *testing.T) {
	...
	if len(migrations) != 16 || migrations[8].Version != "0009" || migrations[9].Version != "0010" || migrations[10].Version != "0011" || migrations[11].Version != "0012" || migrations[12].Version != "0013" {
...
func TestAdminOperationResponseTargetMigrationContract(t *testing.T) {
	...
	if len(migrations) != 16 || migrations[9].Version != "0010" || migrations[10].Version != "0011" || migrations[11].Version != "0012" || migrations[12].Version != "0013" {
...
func prepareAdminResponseTargetPrefix(t *testing.T, gdb *gorm.DB) []string {
	...
	permissionUp(t, gdb)
	migrations, err := All()
	if err != nil || len(migrations) != 16 || migrations[9].Version != "0010" || migrations[10].Version != "0011" || migrations[11].Version != "0012" || migrations[12].Version != "0013" {
