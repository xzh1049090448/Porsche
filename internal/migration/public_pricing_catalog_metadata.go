...
(column_name IN ('endpoint_types','public_restrictions') AND column_type='json' AND is_nullable='NO' AND character_set_name IS NULL AND collation_name IS NULL) OR
