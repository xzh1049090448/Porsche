...
func TestAdminActionOutboxMigrationContract(t *testing.T) {
	...
	if len(migrations) != 13 || migrations[5].Version != "0006" || migrations[6].Version != "0007" || migrations[7].Version != "0008" || migrations[8].Version != "0009" || migrations[9].Version != "0010" {
