...
func TestAdminOperationSafetyRealMySQLDownUpAndVerifier(t *testing.T) {
	...
	if len(migrations) != 11 || migrations[4].Version != "0005" || migrations[5].Version != "0006" || migrations[6].Version != "0007" || migrations[7].Version != "0008" || migrations[8].Version != "0009" || migrations[9].Version != "0010" || migrations[10].Version != "0011" {
...
func TestMigrationSequencePreservesPublishedChecksums(t *testing.T) {
	...
	want := []struct {
		...
		{"0011", "04fdec9c97d6f5fa4cde6f3ee93109bb5bb040a142928c24ba1766aae669a098"},
	}
