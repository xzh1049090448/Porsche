...
func publicContentPricingTableContracts() []publicContentPricingTableContract {
	return []publicContentPricingTableContract{
		{table: publicContentPricingTable("public_model_configs", publicContentPricingColumns(
			...
			publicColumn("capabilities", "json", "NO", "", "", ""),
		...
		{table: publicContentPricingTable("public_price_snapshot_items", publicContentPricingColumns(
			...
			publicColumn("display_name", "varchar(128)", "NO", "", "utf8mb4", "utf8mb4_unicode_ci"), publicColumn("provider", "varchar(128)", "NO", "", "utf8mb4", "utf8mb4_unicode_ci"), publicColumn("capabilities", "json", "NO", "", "", ""), publicColumn("context_window", "bigint", "NO", "", "", ""),
		...
		{table: publicContentPricingTable("public_content_drafts", publicContentPricingColumns(
			publicColumn("document_kind", "int", "NO", "", "", ""), publicColumn("payload", "json", "NO", "", "", ""), publicColumn("revision", "bigint", "NO", "1", "", ""), publicColumn("review_state", "int", "NO", "1", "", ""),
		...
		{table: publicContentPricingTable("public_content_releases", publicContentPricingColumns(
			publicColumn("document_kind", "int", "NO", "", "", ""), publicColumn("version", "bigint", "NO", "", "", ""), publicColumn("source_revision", "bigint", "NO", "", "", ""), publicColumn("payload", "json", "NO", "", "", ""), publicColumn("content_hash", "char(64)", "NO", "", "ascii", "ascii_bin"), publicColumn("restored_from_release_id", "bigint", "YES", "", "", ""), publicColumn("published_at", "bigint", "NO", "", "", ""),
